...
function ContactForm() {
  ...
  const WHATSAPP_NUMBER = '254114093651' // ← replace with real number, no + or spaces
  ...
  return (
    <section
      id="contact"
      className="bg-white border-t border-black flex flex-col items-center justify-center px-8 py-24"
    >
      <div className="w-full max-w-xl">
        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <h2 className="text-xs tracking-[0.5em] uppercase text-black">Get In Touch</h2>
          <div className="h-px flex-1 bg-black/20" />
        </div>

        <p className="text-center text-neutral-400 text-sm mb-10 tracking-wide">
        ...
        <div className="flex flex-col gap-5">
          <div className="relative">
            <input
              ...
              className="w-full border-b border-black bg-transparent text-black placeholder-neutral-300 text-sm py-3 px-0 outline-none focus:border-black tracking-wide transition-colors"
            />
          </div>
          ...
          <button
            onClick={handleSend}
            className="group relative self-start mt-4"
          >
            <span className="flex items-center gap-3 border border-black text-black text-xs tracking-[0.35em] uppercase px-10 py-4 relative z-10 transition-all duration-300 group-hover:bg-black group-hover:text-white">
              {/* WhatsApp icon */}
        ...
        <p className="text-center text-neutral-300 text-xs mt-16 tracking-widest uppercase">
          © 2025 Vade
        </p>
      </div>
    </section>
